...
import { BackgroundPlayer, Player } from '../lib/protobuf/response/player_pb'
import { Setting, SettingItem, SubSetting } from '../lib/protobuf/response/setting_pb'
...
export class SettingMessage extends YouTubeMessage {
  ...
  pure (): YouTubeMessage {
    this.iterate(this.message.settingItems, 'categoryId', (obj: { categoryId: number, subSettings: SubSetting[] }) => {
