...
!function (g) {
    ...
    !function (r, e, t) {
        ...
        15: [function (t, i, n) {
            i.exports = u
            var r, o = t(22),
              e = (((u.prototype = Object.create(o.prototype)).constructor = u).className = 'Field', t(14)), h = t(32),
              f = t(33), c = /^required|optional|repeated$/
        ...
        21: [function (t, i, n) {
            ...
            a.fromJSON = function (t, i) {
                ...
                if (r) {
                    ...
                    for (var e = 0; e < this.nestedArray.length; ++e) if (this.e[e] instanceof a && (r = this.e[e].lookup(t, i, !0))) return r
                }
        ...
        23: [function (t, i, n) {
            i.exports = u
            var e = t(22),
              r = (((u.prototype = Object.create(e.prototype)).constructor = u).className = 'OneOf', t(15)), s = t(33)
        ...
        26: [function (t, i, n) {
                ...
                function a (n, r) {
                    if (!~u.files.indexOf(n)) {
                        if (u.files.push(n), n in v) {
                            o ? c(n, v[n]) : (++l, setTimeout(function () {
                                --l, c(n, v[n])
                            }))
                        } else if (o) {
                            var t
            ...
            h.prototype.u = function (t) {
                ...
                var i
                if (t instanceof s) {
                    t.extend !== g && (t.extensionField ? (t.extensionField.parent.remove(t.extensionField), t.extensionField = null) : -1 < (i = this.deferred.indexOf(t)) && this.deferred.splice(i, 1))
                } else if (t instanceof u) {
            ...
            n['.google.protobuf.Any'] = {
                fromObject: function (t) {
                    if (t && t['@type']) {
                        ...
                        if (n) {
                            return ~(i = '.' == (t['@type'][0] || '') ? t['@type'].slice(1) : t['@type']).indexOf('/') || (i = '/' + i), this.create({
                                type_url: i,
